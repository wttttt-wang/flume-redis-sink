...
public class RedisPublishSink extends AbstractSink implements Configurable{
	private static final Logger logger = LoggerFactory.getLogger(RedisPublishSink.class);

    protected BinaryJedis jedis;   // jedis, for operations on redis using java
    ...
    public synchronized void start(){
        // 1. new Jedis object, pwd(auth), connect
